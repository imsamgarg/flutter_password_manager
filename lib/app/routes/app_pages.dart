...
import 'package:password_manager/app/modules/change_master_password/bindings/change_master_password_binding.dart';
import 'package:password_manager/app/modules/change_master_password/views/change_master_password_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.CHANGE_MASTER_PASSWORD,
      page: () => ChangeMasterPasswordView(),
